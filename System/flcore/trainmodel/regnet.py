import numpy as np
from flcore.trainmodel.reglayers import AnyNet
...
def regnet_200m(**kwargs):
    model = RegNet(regnet_200M_config)
    return model

def regnet_400m(**kwargs):
    model = RegNet(regnet_400M_config)
    return model

def regnet_600m(**kwargs):
    model = RegNet(regnet_600M_config)
    return model

def regnet_800m(**kwargs):
    model = RegNet(regnet_800M_config)
    return model

def regnet_1600m(**kwargs):
    model = RegNet(regnet_1600M_config)
    return model

def regnet_3200m(**kwargs):
    model = RegNet(regnet_3200M_config)
    return model

def regnet_4000m(**kwargs):
    model = RegNet(regnet_4000M_config)
    return model

def regnet_6400m(**kwargs):
    model = RegNet(regnet_6400M_config)
    return model
