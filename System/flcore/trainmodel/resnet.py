...
# from models import BlockSplitRN34, BlockSplitRN50
...
# 应用在resnet50及其以上的结构，主要是1x1,3x3,1x1
...
# if __name__=='__main__':
    # RN6 = resnet6()
    # print(RN6)
#     RN101 = resnet101(num_classes=10)
#     print(RN101)
    # Resnet50 = BlockSplitRN50(RN50)
    # # print(RN50)
    # print(Resnet50)
    # X = torch.rand(size=(10, 3, 32, 32), dtype=torch.float32)
    # # for block_name, block in Resnet34.blocks.items():
    # #     X = block(X)
    # #     print(X.shape)
    # print(Resnet50(X))
